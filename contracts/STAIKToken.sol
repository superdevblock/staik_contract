...
contract STAIKToken is ERC20, Ownable {
    ...
    function setPurchasePercent(uint256 percent) public {
        purchasePercent = percent;
    }

    function setSellPercent(uint256 percent) public {
        sellPercent = percent;
    }
